...
export interface TextFieldProps
  extends Omit<React.ComponentProps<"textarea">, "width" | "height"> {
...
const TextField = React.forwardRef<HTMLTextAreaElement, TextFieldProps>(
  ({ className, variant = "default", width, height, onChange, ...props }, ref) => {
    ...
    const adjustHeight = React.useCallback(() => {
      const textarea = typeof textareaRef === 'function' ? internalRef.current : textareaRef.current;
      if (textarea) {
