  ...
  return (
    <>
      {open && (
        ...
        >
          {/* 헤더 */}
          <div className='mt-[0.5rem] mb-[2rem] flex flex-col gap-[0.75rem]'>
            <h2 className='text-left text-[1.125rem] font-bold text-[#1A1A1A]'>
              {titleText}
            </h2>
            <p className='text-[0.875rem] leading-[1.4] font-medium whitespace-pre-line text-[#464B53]'>
              {descriptionText}
            </p>
          </div>

          {/* 스탬프 보드 */}
          <div className='mb-[2rem] flex w-full flex-col'>
            <div className='relative flex w-full flex-col items-center'>
              {/* 배경 선 (수정된 SVG) */}
              <svg
                className='absolute top-[2.25rem] left-1/2 z-0 -translate-x-1/2'
                width='300'
                height='290'
                viewBox='0 0 300 290'
                fill='none'
              ...
              >
                <path
                  d='M250 97C262.996 97 275.459 91.9956 284.648 83.0876C293.838 74.1796 299 62.0978 299 49.5C299 36.9022 293.838 24.8204 284.648 15.9124C275.459 7.00445 262.996 2 250 2'
                  stroke='#CDD0D5'
                  strokeWidth='2'
                />
                <path
                  d='M250 289C262.996 289 275.459 283.996 284.648 275.088C293.838 266.18 299 254.098 299 241.5C299 228.902 293.838 216.82 284.648 207.912C275.459 199.004 262.996 194 250 194'
                  stroke='#CDD0D5'
                  strokeWidth='2'
                />
                <path
                  d='M50 97C37.0044 97 24.541 102.004 15.3518 110.912C6.16248 119.82 0.999998 131.902 0.999998 144.5C0.999997 157.098 6.16248 169.18 15.3518 178.088C24.541 186.996 37.0044 192 50 192'
                  stroke='#CDD0D5'
                  strokeWidth='2'
                />
                <line
              ...
              {/* 첫 번째 줄: 1 2 3 */}
              <div className='relative z-10 mb-[1.5rem] flex w-full justify-center gap-[1.75rem]'>
              ...
              {/* 두 번째 줄: 4 5 (왼쪽 정렬) */}
              <div className='relative z-10 mb-[1.5rem] flex w-full justify-center gap-[2rem]'>
          ...
          {/* 아코디언 가이드 */}
          <div className='mb-[1rem] space-y-3'>
            <button
              type='button'
              onClick={() => setIsOpen(!isOpen)}
              className='flex cursor-pointer items-center gap-1 text-[0.875rem] font-bold text-[#1A1A1A]'
            >
              <ChevronDownIcon
                className={cn(
            ...
            {isOpen && (
              <div className='flex flex-col gap-[1rem]'>
                <ul className='flex list-disc flex-col gap-[0.5rem] pl-[2.5rem] text-[0.75rem] leading-[1.5] text-[#464B53]'>
                  <li>
                    이벤트 진행 기간 (2026년 4/1 ~ 4/31) 동안 <br />
                    작성된 로그만 인정돼요.
                  </li>
...
function StampSlot({
  ...
  if (isReward) {
    return (
      <div
        className={cn(
          'z-20 flex h-[4.5rem] w-[4.5rem] flex-shrink-0 items-center justify-center rounded-full border-2 border-[#5060C5] bg-[#F6F8FA] text-center text-[0.75rem] leading-tight font-bold text-[#5060C5]',
        )}
      >
        {active ? (
          <BigStamp />
