              ...
              <div className='flex flex-col gap-[1.25rem]'>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  <p>
                    ...
                    마케팅 정보(서비스 업데이트, 이벤트·프로모션, 설문조사,
                    신규 기능 안내 등)를 전송하기 위해 필요한 수신 동의 사항을
                    규정함을 목적으로 합니다.
                  </p>
                </div>
              </div>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  <div className='flex flex-col gap-[0.75rem]'>
                    ...
                    <p>
                      ...
                      &apos;마케팅 목적 이용&apos;을 중단합니다. 단, 서비스
                      가입 및 이용을 위해 필수 수집된 식별 정보는 회사
                      「개인정보처리방침」에 명시된 기간 동안 안전하게 보관됩니다.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  <div className='flex flex-col gap-[0.75rem]'>
                    <p>
                      ...
                      불이익이 없습니다. 단, 동의 거부 시 마케팅 정보를 통한 유용한
                      혜택 제공이 제한될 수 있습니다.
                    </p>
                  </div>
                </div>
