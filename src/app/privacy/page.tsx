          ...
          <div className='flex flex-col gap-[1.25rem] px-[0.5rem]'>
            <div className='flex w-full flex-col gap-[3.75rem] rounded-[1.75rem] border border-[#CDD0D5] px-[2.5rem] py-[2.25rem]'>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  ...
                  <div className='flex flex-col gap-[0.75rem]'>
                    ...
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - 소셜 로그인(OAuth) 연동 본인 확인, 가입 의사 확인,
                        계정 통합 처리, 다중 계정 생성 및 이용권 부정 수급
                        방지, 고객 문의 대응
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col gap-[0.75rem]'>
                    ...
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - 유료 이용권 구매 및 결제 처리, 이용권 지급·사용·만료·환불
                        처리, AI 기반 커리어 지원 서비스 제공
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col gap-[0.75rem]'>
                    <p>3. 서비스 개선 및 통계 분석</p>
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - 서비스 이용 기록 기반의 통계 분석, 신규 기능 개발 및
                        AI 서비스 품질 향상
                      </p>
                    </div>
                  </div>
              ...
              <div className='flex flex-col gap-[1.25rem]'>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  <div className='flex flex-col gap-[0.75rem]'>
                    <p>1. 회원가입 시 필수 수집 항목</p>
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - 성명, 이메일 주소, 로그인타입, 로그인식별자, 전화번호
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col gap-[0.75rem]'>
                    <p>2. 서비스 이용 과정에서 자동으로 생성·수집되는 항목</p>
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - IP 주소, 접속 로그, 쿠키, 서비스 이용 기록, 기기 정보
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col gap-[0.75rem]'>
                    <p>3. 유료 이용권 결제 시 수집 항목</p>
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - 결제 수단 정보 (PayAPP을 통한 신용카드, 계좌번호 등
                        일부 정보)
                      </p>
                    </div>
                  </div>
              ...
              <div className='flex flex-col gap-[1.25rem]'>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  ...
                  <div className='flex flex-col gap-[0.75rem]'>
                    ...
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - 회원 탈퇴 시 이름, 이메일 주소, 로그인 식별자 등 기본
                        식별 정보는 지체 없이 영구 파기됩니다.
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col gap-[0.75rem]'>
                    <p>2. 부정이용 방지를 위한 전화번호 보관</p>
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - 무료 이용권 중복 수급, 다중 계정 생성 등 서비스 부정
                        이용 방지를 위하여 회원 탈퇴일로부터 1년간 전화번호를
                        암호화하여 보관한 후 파기합니다.
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col gap-[0.75rem]'>
                    ...
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        ...
                        모든 이용권에 대한 거래 내역 (구매, 지급, 사용, 만료,
                        환불 등에 관한 기록)은 5년간 보관됩니다.
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col gap-[0.75rem]'>
                    <p>4. AI 생성 데이터의 분리 보관</p>
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>
                        - 이용 메타데이터와, 서비스 내 AI를 사용하는 기능 사용
                        시 입력 및 생성된 데이터 결과물은 회원 탈퇴 시 계정(User
                        ID)과의 연결이 영구적으로 해제되며, 특정 개인을 식별할 수
                        없는 데이터 상태로 서비스 품질 향상을 위해 영구
                        보관됩니다.
                      </p>
                    </div>
                  </div>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  <div className='flex flex-col gap-[0.75rem]'>
                    ...
                    <p>
                      ...
                      처리 업무를 외부에 위탁하고 있습니다.
                    </p>
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>- 서버 및 데이터 보관: Amazon Web Services (AWS)</p>
                      <p>- 결제 처리 (PG): PayAPP (페이앱)</p>
                      <p>
                        - AI 텍스트 및 이미지 처리: OpenAI (※ 전송된 데이터는 AI
                        모델 학습용으로 사용되지 않습니다.)
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col gap-[0.75rem]'>
                    ...
                    <div className='flex flex-col gap-[0.75rem] px-[2.5rem]'>
                      <p>- 이용자가 사전에 동의한 경우</p>
                      <p>
                        - 법령의 규정에 따른 경우 또는 수사 목적으로 법령에 정해진
              ...
              <div className='flex flex-col gap-[1.25rem]'>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  <p>
                    ...
                    보관 정보를 제외한 개인 식별 정보는 복구 불가능한 방법으로
                    파기됩니다.
                  </p>
                </div>
              </div>
              ...
              <div className='flex flex-col gap-[1.25rem]'>
                ...
                <div className='flex flex-col gap-[1.25rem] px-[0.25rem] text-[1rem] leading-[150%] text-[#464B53]'>
                  <div className='flex flex-col gap-[0.75rem]'>
                    <p>1. 본 방침은 2026년 3월 9일부터 적용됩니다.</p>
                    <p>
