          ...
          <div className='flex flex-col gap-[3.125rem]'>
            ...
            <div className='flex flex-col gap-[1.25rem]'>
              <div className='flex items-center gap-[1.25rem]'>
                <span className='typo-h4 font-bold md:text-[1.5rem]'>
                  서비스 이용약관
                </span>
              </div>
            ...
            {/* 내용 */}
            <div className='flex flex-col gap-[1.25rem] md:px-[1.25rem]'>
              <div className='flex w-full flex-col gap-[2.5rem] rounded-[1.75rem]'>
                {/* 제 1조 (목적) */}
                <div className='typo-c1-sb text-[#1A1A1A] md:text-[1.125rem] md:font-bold'>
                  제 1조 (목적) <br />
                  <p className='font-regular typo-c1 leading-[150%] md:text-[1.125rem]'>
                ...
                <div className='typo-c1-sb text-[#1A1A1A] md:text-[1.125rem] md:font-bold'>
                  ...
                  <p className='font-regular typo-c1 leading-[150%] md:text-[1.125rem]'>
                    ...
                    <span className='ml-[0.25rem] block'>
                      ...
                      구매한 이용권을 말하며, &quot;무료 이용권&quot;이란 회사가
                      이벤트를 통해 무상으로 지급한 이용권을 말합{' '}
                      {'\u00A0\u00A0\u00A0\u00A0\u00A0'}
                      니다.
                    </span>
                  </p>
                ...
                <div className='typo-c1-sb text-[#1A1A1A] md:text-[1.125rem] md:font-bold'>
                  ...
                  <p className='font-regular typo-c1 ml-[0.25rem] leading-[150%] md:text-[1.125rem]'>
                    1. 소진 순서
                    <br />
                    {'\u00A0\u00A0'}
                    • 회원이 서비스를 이용하여 이용권이 차감될 때, 유료 및 무료
                    여부와 관계없이 계정에 부여된 일자가 가장 빠른 이용권부터
                    우선 차감됩니다.
                    <br />
                    2. 유효기간
                    <br />
                    {'\u00A0\u00A0'}• 모든 이용권 (유료 및 무료 포함)의
                    유효기간은 획득일로부터 6개월입니다. 유효기간이 경과한
                    이용권은 자동 소멸하며, 복구되거나 환불하지
                    <br />
                    {'\u00A0\u00A0\u00A0\u00A0\u00A0'}않습니다.
                    <br />
                    3. 예외 사항
                ...
                <div className='typo-c1-sb text-[#1A1A1A] md:text-[1.125rem] md:font-bold'>
                  ...
                  <p className='font-regular typo-c1 leading-[150%] md:text-[1.125rem]'>
                    ...
                    <span className='ml-[0.25rem] block'>
                      ...
                      이용권을 단 1회도 사용하지 않은 상태에 한하여 100% 결제
                      취소 및 전액 환불을 요청할
                      <br />
                      {'\u00A0\u00A0\u00A0\u00A0\u00A0'}수 있습니다.
                      <br />
                      ...
                      1회 이상 사용한 이력이 있는 경우 아래의 산정식에 따라 부분
                      환불이 진행됩니다.
                      <br />
                      {'\u00A0\u00A0'}
                      ...
                      <br />
                      {'\u00A0\u00A0'}• 위 산정식에서 &apos;1회 이용권
                      정상가&apos;라 함은 서비스 내 결제 화면에 명시된 해당
                      기능의 &quot;할인이 적용되지 않은 1회권 가격&quot;에
                      해당하는 금액을
                      <br />
                      {'\u00A0\u00A0\u00A0\u00A0\u00A0'}의미합니다. (예: 묶음/
                      ...
                      <br />
                      {'\u00A0\u00A0'}
                      • 최종 환불 금액은 회원의 환불 요청 접수 후 담당자의 확인
                      및 정산 절차를 거쳐 확정됩니다.
                      <br />
                      {'\u00A0\u00A0'}
                      ...
                      4. 부정이용에 따른 조치
                      <br />
                      {'\u00A0\u00A0'}• 회원이 타인의 결제 정보를 도용하거나,
                      다중 계정 생성 등 부정한 방법으로 이용권을 무상 취득 및
                      사용하는 경우, 회사는 사전 통보 없이 해당
                      <br />
                      {'\u00A0\u00A0\u00A0\u00A0\u00A0'}이용권을 전량 회수하고
                ...
                <div className='typo-c1 font-bold text-[#1A1A1A] md:text-[1.125rem]'>
                  제 6조 (서비스의 중단 및 책임 제한)
                  <br />
                  <p className='font-regular typo-c1 ml-[0.25rem] leading-[150%] md:text-[1.125rem]'>
                    1. 회사는 정기 점검, 외부 API의 연동 장애, 클라우드 서버
                    오류, 통신 장애 등 불가피한 사유가 발생한 경우 서비스 제공을
                    일시적으로 중단할 수
                    <br />
                    {'\u00A0\u00A0\u00A0\u00A0'}있습니다.
                    <br />
                    ...
                    관련하여 회원에게 발생한 손해 및 서비스 중단에 대해서는
                    어떠한 법적 책임도 지
                    <br />
                    {'\u00A0\u00A0\u00A0\u00A0'}지 않습니다.
                    <br />
