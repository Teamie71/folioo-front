...
import InvoiceRefundClientMobile from './InvoiceRefundClientMobile';
...
export default function InvoiceRefundPage() {
  ...
  // 데스크탑 전용 제출 가능 여부 (계좌 정보 포함)
  const canSubmitDesktop =
    !!selectedReason &&
    !!selectedBank &&
    accountHolder.trim() !== '' &&
    accountNumber.trim() !== '';

  // 모바일 전용 제출 가능 여부 (계좌 정보 제외 - 시안 기준)
  const canSubmitMobile = !!selectedReason;

  return (
    <>
      <div className='md:hidden'>
        <InvoiceRefundClientMobile
      ...
      <div className='mx-auto hidden w-[66rem] min-w-[66rem] flex-col gap-[3.75rem] pt-[3.75rem] pb-[6.25rem] md:flex'>
        {/* 헤더 */}
