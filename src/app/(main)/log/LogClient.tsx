...
import { useLogStore, type LogCardData } from '@/store/useLogStore';
            ...
            <div className='flex flex-col gap-[0.5rem]'>
              <div className='flex items-center gap-[0.5rem] text-[1.125rem]'>
                <div className='flex items-center gap-[0.25rem]'>
                  ...
                  <span className='font-bold text-[#DC0000]'>*</span>
                </div>
                {errors.title && (
                  <span className='text-[0.875rem] font-normal text-[#DC0000]'>
                    {errors.title}
                  </span>
                )}
              </div>
