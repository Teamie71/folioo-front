        ...
        {status === 'ANALYZING' ? (
          ...
          <>
            ...
            <div className='flex justify-center pb-[7rem]'>
              <button
                ...
                className={`flex h-[48px] w-[207px] cursor-pointer items-center justify-center rounded-[3.75rem] border-none ${
          ...
          <>
            ...
            <div className='flex justify-center pb-[7rem]'>
              <button
                onClick={handleNextStep}
                className='flex h-[48px] w-[207px] cursor-pointer items-center justify-center rounded-[3.75rem] border-none bg-[#5060C5]'
              >
                <span className='text-[1rem] font-bold text-[#FFFFFF]'>
                  첨삭 의뢰하기
                </span>
