    ...
    <div className='mx-auto w-full max-w-[66rem] py-[2rem]'>
      <div className='flex flex-col pb-[10rem]'>
        ...
        <div>
          ...
          <div className='mt-[1.25rem] flex flex-col gap-[1.75rem] rounded-[1.5rem] border border-[#CDD0D5] bg-[#FDFDFD] p-[1.75rem]'>
            ...
            <div className='flex items-start gap-[0.75rem]'>
              ...
              <p className='text-[1.125rem] leading-[150%] font-semibold text-[#000000]'>
                지금 탈퇴하시면 생성한 커리어 기록과 남은 이용권이 모두
                소멸돼요.
              </p>
            </div>
          ...
          {/* 개인정보처리방침 링크 */}
          <div className='mt-[1.25rem] h-[1.5rem] pl-[1.75rem] text-[1rem] leading-[1.5rem] text-[#74777D]'>
            개인정보 관련 자세한 규정은{' '}
          ...
          <div className='mt-[0.75rem] h-[1.5rem] pl-[1.75rem] text-[1rem] leading-[1.5rem] text-[#74777D]'>
          ...
          {withdrawReason === '3' && (
            <div className='mt-[2rem] pl-[1.75rem]'>
              <p className='text-[1rem] leading-[150%] text-[#000000]'>
                ...
                <br />
                기능을 개선할 수 있도록 피드백을 남겨주시면, 더 좋은 결과물을
                얻으실 수 있도록 노력할게요.
                <br />
          ...
          {withdrawReason === '4' && (
            <div className='mt-[1.5rem] pl-[1.75rem]'>
              <TextField placeholder='이유를 알려주세요.' height='8rem' />
            </div>
          )}
