    ...
    <div className='w-full overflow-x-hidden'>
      ...
      <div className='relative'>
        ...
        <section className='relative z-10 mx-auto flex w-full max-w-[66rem] flex-col gap-[2.5rem] px-4 pt-[4rem] pb-[3rem]'>
          ...
          >
            <h1 className='text-center text-[1.75rem] leading-[130%] font-bold text-[#000000]'>
              당신의 모든 경험을 <br /> 무한한 취업 경쟁력으로
            </h1>
            <p className='text-center text-[0.9375rem] leading-[130%] font-bold text-[#000000]'>
        ...
        <motion.section
          ...
          className='relative z-10 mx-auto w-full max-w-[66rem] px-4 pb-12'
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.2 }}
        ...
        >
          <div className='flex flex-col gap-8'>
            <div className='flex flex-col gap-4'>
              <p className='text-[1rem] font-bold leading-[130%] text-[#000000]'>
                인사이트 로그
              </p>
              <h2 className='text-[1.25rem] font-bold leading-[130%] text-[#000000]'>
                스쳐 지나가는 작은 인사이트,
                <br />
                나를 증명하는 스토리로
              </h2>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <p className='text-[0.875rem] leading-[150%] text-[#000000]'>
                기업이 진짜 궁금한 건, &apos;무엇을 했는지&apos;보다 &apos;무엇을
                느꼈는지&apos;예요.
              </p>
              <p className='text-[1rem] font-bold leading-[130%] text-[#000000]'>
                Why? 에 최적화된 템플릿으로 쉽고 빠르게 나의 가치를 기록하세요.
              </p>
            </div>
            <div className='flex flex-col gap-4'>
              <LandingVideo src='/landing/log2.mp4' />
              <p className='text-[0.875rem] leading-[150%] text-[#000000]'>
                쌓인 기록들은 풍부한 경험 정리의 재료이자, 채용 사이클 전체에서
                활용 가능한 핵심 자산이 돼요.
              </p>
            </div>
          </div>
      ...
      >
        <div className='mx-auto flex max-w-[66rem] flex-col gap-12 px-4'>
          <motion.div
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: 'easeOut' }}
          >
            <p className='text-[1rem] font-bold leading-[130%] text-[#74777D]'>
              How It Works
            </p>
            <ExperienceHIW />
          </motion.div>
      ...
      >
        <div className='relative'>
          ...
          />
          <div className='relative z-10 mx-auto max-w-[66rem] px-4'>
            <div className='flex flex-col gap-4'>
              <p className='text-[1rem] font-bold leading-[130%] text-[#000000]'>
                포트폴리오 첨삭
              </p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, ease: 'easeOut' }}
            >
              <p className='text-[1.125rem] font-bold leading-[130%] text-[#000000]'>
                AI 컨설턴트가 제공하는 <br />
          ...
          <motion.div
            className='mx-auto flex max-w-[66rem] flex-col gap-6 px-4 pt-10'
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.2 }}
            transition={{ duration: 0.6, ease: 'easeOut' }}
          >
            <p className='text-center text-[1rem] font-bold leading-[130%] text-[#74777D]'>
              How It Works
            </p>
            <PortfolioHIW />
          </motion.div>
