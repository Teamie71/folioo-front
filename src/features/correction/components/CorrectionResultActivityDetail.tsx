...
export function CorrectionResultActivityDetail({
  ...
  const renderMarkdown = (text: string, lines: CorrectionLineItemReqDTO[], activeFilter: 'reduce' | 'emphasize') => {
    // Add hyphen and newline to the beginning of each line
