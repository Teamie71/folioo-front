      ...
      <section className='relative overflow-hidden py-[7.5rem] sm:min-h-[113.6875rem] sm:py-[10rem]'>
        ...
        <div className='relative z-20 mx-auto max-w-[66rem] px-5 sm:px-0'>
          ...
          <div className='relative mt-24 min-h-[19rem] sm:mt-[8.75rem] sm:min-h-[34.875rem]'>
            ...
            >
              <span className='absolute top-0 left-1/2 h-[1.375rem] w-[17.625rem] -translate-x-1/2 rounded-full bg-white opacity-30 blur-[0.625rem]' />
              <span className='absolute top-[1.875rem] left-1/2 h-[1.125rem] w-48 -translate-x-1/2 rounded-full bg-white opacity-50 blur-[0.625rem]' />
              <span className='absolute top-[3.5rem] left-[calc(50%+1.5px)] h-[0.6875rem] w-[7.5625rem] -translate-x-1/2 rounded-full bg-white opacity-70 blur-[0.625rem]' />
              <span className='absolute top-[4.6875rem] left-[calc(50%+2px)] h-1.5 w-[4.75rem] -translate-x-1/2 rounded-full bg-white opacity-90 blur-[0.625rem]' />
            </div>
